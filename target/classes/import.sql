...
INSERT INTO tb_projeto(nome_projeto, descricao_projeto, data_prevista_entrega, data_conclusao, status) values ('Aplicativo Mobile', 'Fazer um aplicativo mobile para gerenciar uma pet shop', '2024-10-30', null, true);

UPDATE tb_funcionario set projeto_id = 1 where id_funcionario = 2;

INSERT INTO tb_funcionario_projeto(data_participacao_inicial, data_participacao_final, projeto_id, funcionario_id) values('2024-10-04', null, 1, 2);
